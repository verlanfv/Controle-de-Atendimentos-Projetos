object frmBaseDados: TfrmBaseDados
  Left = 575
  Top = 218
  ActiveControl = mmoProblema
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Manuten'#231#227'o Base de Dados'
  ClientHeight = 475
  ClientWidth = 529
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Label1: TLabel
        ...
        Width = 77
        Height = 13
        Caption = 'C'#243'd. Solu'#231#227'o'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object Label3: TLabel
        ...
        Width = 90
        Height = 13
        Caption = 'Descri'#231#227'o Solu'#231#227'o'
      end
      ...
      object Label5: TLabel
        ...
        Width = 275
        Height = 13
        Caption = 'Obs.: Para facilitar a busca, n'#227'o use acentos nas palavras'
        Color = clBtnFace
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -11
      ...
      object mmoProblema: TDBMemo
        Left = 40
        Top = 72
        Width = 441
        Height = 97
        DataField = 'desc_problema'
        DataSource = dsBaseDados
        ScrollBars = ssVertical
        TabOrder = 1
        OnKeyPress = mmoProblemaKeyPress
      end
      object mmoSolucao: TDBMemo
        ...
        ScrollBars = ssVertical
        TabOrder = 2
        OnKeyPress = mmoSolucaoKeyPress
      end
      object edtPalavraChave: TDBEdit
        Left = 40
        Top = 345
        Width = 441
        Height = 21
        CharCase = ecUpperCase
        DataField = 'palavra_chave'
        DataSource = dsBaseDados
        TabOrder = 3
      end
    end
